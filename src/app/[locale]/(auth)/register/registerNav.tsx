        ...
        <>
            <form>
                ...
                <div className='form-row text-center mt-4'>
                    ...
                    <button name="register" disabled={registerByEmailMutation.isPending} type="button" className="btn btn-outline-primary" onClick={showSlideCaptcha}>{t('register')}</button>
                </div>
            </form>
        </>
    )
