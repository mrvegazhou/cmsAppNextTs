...
import OverlayComp, { OverlayProps, css as overlayCSS } from './overlay'
import { IBoundingClientRect } from './util/getBoundingClientRect';
import { getStyle } from './getStyle';

export let cssOutput = (position : string = 'absolute')=> {
  return `
  ${overlayCSS}
...
OverLayTriggerComp.displayName = "OverLayTriggerComp";
