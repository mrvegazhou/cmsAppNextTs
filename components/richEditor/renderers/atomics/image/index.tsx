...
const ImageRenderer = (props: ImageRenderProps) => {
    ...
    const { dataURL, src, width, height, description } = props.mediaData;
            ...
            >
                ...
                >
                    <div className="d-flex flex-column align-items-center">
                        <Image ref={imageEleRef} src={dataURL} alt="Alt" width={imgSize.width} height={imgSize.height} />
                        {inputDescVisible ? (
                            ...
                            />
                                        ...
                                        style={{fontSize:"14px"}}>{changeImgDesc ? changeImgDesc : 'dfdf'}
                            </figcaption>)}
