    ...
    return <>
        <form>
            ...
            <div className='form-row text-center mt-4'>
                ...
                <button name="confirmVerify" disabled={changeNewPwdByEmailCodeMutation.isLoading} type="button" className="btn btn-outline-primary " onClick={onSubmitChangePwdByEmailCode}>{t('modifyPassword')}</button>
            </div>    
        </form>
    </>
}
