            ...
            <div className="col ps-0 pe-3">
                ...
                <form>
                    ...
                    <div className="text-center col-sm-10">
                        <button type="button" disabled={registerByEmailMutation.isLoading} className="btn btn-outline-primary mt-4 mb-3 w-50" onClick={showSlideCaptcha}><span>{t('regInNow')}</span></button>
                    </div>
                </form>
                </div>
            </div>
